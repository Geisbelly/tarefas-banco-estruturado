...
export const criarTask = async (req, res) => {
  try {
    const body = req.body;
    const novaTarefa = await criarTarefa(body.titulo, body.descricao, body.criador, body. body.status, body.tags, body.dataCriacao, body.dataConclusao, body.comentarios);
