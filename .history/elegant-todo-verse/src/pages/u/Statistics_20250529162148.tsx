...
const Statistics = () => {
  ...
  useEffect(() => {
    // Dados simulados - em uma implementação real, viriam de uma API
    const initialTasks: Task[] = [
      ...
      },
      {
        ...
        descricao: "Revisar artigos sobre inteligência artificial.",
        dataCriacao: new Date("2024-05-18"),
        status: "pendente",
        tags: ["pesquisa", "universidade", "ai"],
        comentarios: [],
        criador: "",
        colaboradores: []
      },
      {
        ...
        dataCriacao: new Date("2024-05-21"),
        status: "concluida",
        tags: ["saúde", "rotina"],
        comentarios: [],
        criador: "",
