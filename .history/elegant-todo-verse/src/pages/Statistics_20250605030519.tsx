  ...
  useEffect(() => {
    ...
    const fetchAllDashboardData = async (email: string, deConcluidas: string, ateConcluidas: string, deCriadas: string, ateCriadas: string) => {
      ...
      try {
        ...
        conts currentConcluidaDate = new Date(dStartConcluidas); // Usa o objeto Date validado
        ...
        try {
            ...
            if (criadasResponse.ok) {
                ...
                const currentCriadaDate = new Date(dStartCriadas); // Usa o objeto Date validado
