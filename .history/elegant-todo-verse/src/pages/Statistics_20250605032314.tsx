...
interface ApiProductivityData {
  ...
  // totalComentarios não é mais esperado da API de produtividade para os cards
}
...
const Statistics = ({
  ...
  return (
    <div className="container mx-auto px-2 sm:px-4 py-8">
      ...
      {/* Cards de Estatísticas - Card de Comentários REMOVIDO */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 mb-8">
        ...
        {/* CARD DE COMENTÁRIOS FOI REMOVIDO */}
        <Card>
      ...
      try {
        ...
        try {
            ...
            if (criadasResponse.ok) {
                ...
                let currentCriadaDate = new Date(dStartCriadas);
        ...
        const finalGeneralStats = {
          ...
          // totalComments removido das stats
